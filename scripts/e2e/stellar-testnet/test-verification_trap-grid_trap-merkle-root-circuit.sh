...
# ============================================================================
# Trap Merkle Root Circuit - Stellar Testnet Deployment Script
# ============================================================================
# This script deploys and verifies ONLY the trap-merkle-root circuit
# on Stellar testnet.
#
# ✅ Circuit (trap-merkle-root) successfully verifies on testnet!
#
# The trap merkle root circuit computes and verifies merkle roots for trap
# values using binary merkle tree and poseidon hash.
#
# CIRCUIT:
# - trap-merkle-root: Computes and verifies merkle roots using
...
# ============================================================================
# CIRCUIT: trap-merkle-root
# ============================================================================
echo ""
echo "════════════════════════════════════════════════════════════"
echo "CIRCUIT: trap-merkle-root"
echo "════════════════════════════════════════════════════════════"
...
# ============================================================================
# DEPLOY AND VERIFY CIRCUIT: trap-merkle-root
# ============================================================================
echo ""
echo "════════════════════════════════════════════════════════════"
echo "DEPLOY CIRCUIT: trap-merkle-root"
echo "════════════════════════════════════════════════════════════"
...
echo "==> Deployed Trap Merkle Root Contract ID: $CID_MERKLE_ROOT"
echo ""
echo "═══════════════════════════════════════"
echo "✅ Circuit deployment successful!"
echo "🔗 Contract ID: $CID_MERKLE_ROOT"
echo "═══════════════════════════════════════"
echo ""
echo "==> 3a) Check proof and public input sizes"
PROOF_SIZE=$(wc -c < "$TRAP_MERKLE_ROOT/target/proof" | tr -d ' ')
PUB_INPUT_SIZE=$(wc -c < "$TRAP_MERKLE_ROOT/target/public_inputs" | tr -d ' ')
...
if [ $VERIFY_EXIT -eq 0 ]; then
    ...
    echo "═══════════════════════════════════════════════════════════="
    echo "🎉 The trap-merkle-root circuit proof was verified"
    ...
    echo "Contract ID: $CID_MERKLE_ROOT"
    echo ""
    echo "This demonstrates that the trap merkle root circuit using"
