...
3. **Copy circuit artifact:**
   ...
   cp ../trap-grid/trap-grid-position-movement/target/trap_grid_position_movement.json app/public/circuits/
   ```
...
This generates:
- `target/trap_grid_position_movement.json` - Circuit artifact
